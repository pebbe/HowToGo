...
Demo adapted from https://olivere.github.io/elastic/ for Elasticsearch 2.x
...
func main() {
	...
	update, err := client.Update().Index("twitter").Type("tweet").Id("1").
		Script(elastic.NewScript("ctx._source.retweets += num").Params(map[string]interface{}{"num": 1})).
		Upsert(map[string]interface{}{"retweets": 0}).
		Do()
	if err != nil {
		fmt.Print("Did you add these lines to elasticsearch.yml?\n\nscript.inline: on\nscript.indexed: on\n\n")
		// Handle error
		panic(err)
	}
